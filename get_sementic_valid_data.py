...
def main():
    ...
    val_data_path = 'data/v3/cna_data/cna_valid_unass.json'
    val_public_path = 'data/v3/cna_data/cna_valid_unass_pub.json'
    ...
    val_pub_path = "data/v3/processed/val_pub.pkl"    
    
    classifySet_all_NIL_path = "data/v3/processed/valid_features_nil_3.pkl"
    paper_ids_NIL_path = "data/v3/processed/paper_ids_nil_3.pkl"
    candidate_all_NIL_path = "data/v3/processed/candidate_all_nil_3.pkl"
    ...
    for item in tqdm(NIL):
        ...
        if not candidate:
            candidate_name = mapping_valid.get(name, None)
            if candidate_name:
